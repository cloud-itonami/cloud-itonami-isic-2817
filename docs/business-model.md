# Business Model: Manufacture of office machinery and equipment (except computers and peripheral equipment)
...
## Classification
- Repository: `cloud-itonami-isic-2817` ([github.com/cloud-itonami/cloud-itonami-isic-2817](https://github.com/cloud-itonami/cloud-itonami-isic-2817))
- ISIC Rev.5: `2817` — Manufacture of office machinery and equipment (except computers and peripheral equipment)
- Domain: `:office-machinery/manufacturing`
- Social impact: :worker-safety :electrical-safety :product-quality-integrity
- Actor: `:office-machinery-plant-operations-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :office-machinery/manufacturing — who wants
...
One managed tenant (:office-machinery/manufacturing):
...
- Do not bypass the `:office-machinery-plant-operations-governor` for production decisions.
