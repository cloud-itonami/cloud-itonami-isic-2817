# Operator Quickstart — Manufacture of office machinery and equipment (except computers and peripheral equipment)

Shortest path from clone to a verified local dry-run for **ISIC 2817** (`cloud-itonami-isic-2817`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-2817.git
cd cloud-itonami-isic-2817
```
...
- Blueprint governor key: `office-machinery-plant-operations-governor`
- Likely source path: `officemach.governor.cljc`
