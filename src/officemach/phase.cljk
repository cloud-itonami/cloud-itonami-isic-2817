(ns officemach.phase
  "Phase 0->3 staged rollout for the office-machinery plant-operations
  coordination actor.
  ...
  consequence (an assembly/test-bench-equipment maintenance window
  means production downtime, and the equipment ends up actually
  touched); it is always a human plant supervisor's call.
  `officemach.governor`'s `equipment-actuate-blocked-violations`
...
(defn verdict->disposition
  "Map an Office Machinery Plant Operations Governor verdict to a base
