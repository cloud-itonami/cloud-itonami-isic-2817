(ns officemach.registry-test
  (:require [clojure.test :refer [deftest is]]
            [officemach.registry :as r]))
...
(deftest known-product-types-are-valid
  (doseq [pt [:typewriter :calculator :cash-register :photocopier
...
;; ----------------------------- dielectric-withstand-test-kv-valid? -----------------------------

(deftest typical-dielectric-withstand-test-reading-is-valid
  (is (r/dielectric-withstand-test-kv-valid? 0.0))
  (is (r/dielectric-withstand-test-kv-valid? 1.5))
  (is (r/dielectric-withstand-test-kv-valid? 3.0))
  (is (r/dielectric-withstand-test-kv-valid? 5.0)))

(deftest excessive-dielectric-withstand-test-reading-is-invalid
  (is (not (r/dielectric-withstand-test-kv-valid? 999999.0)))
  (is (not (r/dielectric-withstand-test-kv-valid? 5.01)))
  (is (not (r/dielectric-withstand-test-kv-valid? -0.01))))

(deftest non-numeric-or-missing-dielectric-withstand-test-reading-is-invalid
  (is (not (r/dielectric-withstand-test-kv-valid? nil)))
  (is (not (r/dielectric-withstand-test-kv-valid? "1.5"))))
...
(deftest history-is-append-only
  (let [c1 (r/register-maintenance "mnt-1" "assembly-001" 0)
        hist (r/append [] c1)
        c2 (r/register-maintenance "mnt-2" "assembly-001" 1)
