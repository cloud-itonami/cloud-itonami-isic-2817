...
`cloud-itonami-isic-2817` is an OSS open-business blueprint for
office-machinery plant operations coordination.

## Maintainers
Maintainers may merge changes that preserve these invariants:
- an assembly/test-bench-equipment action the governor refuses is never dispatched to hardware.
- the Office Machinery Plant Operations Governor remains independent of the advisor.
...
- bypassing assembly/test-bench-equipment-control or record policy checks
